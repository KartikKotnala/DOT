      ...
      >
        ...
        <div class="border-t border-b border-line/30 py-4 flex flex-col gap-2.5">
          ...
          <div class="flex flex-col gap-2">
            <button
              v-for="mode in [
                { id: 'lift', label: 'Use Elevator / Lift', icon: '🛗' },
                { id: 'escalator', label: 'Use Escalator Deck', icon: '🪜' },
                { id: 'stairs', label: 'Use Central Stairs', icon: '🚶' }
              ]"
              :key="mode.id"
              type="button"
...
const targetZoom = ref(1.0);
const targetPan = ref({ x: 0, y: 0 });
const sourceZoom = ref(1.0);
